...
function DeleteIssue({issueId}: {issueId: string}) {
    ...
    const deleteProject = () => {
        ...
        const confirmed = window.confirm("Är du säker på att du vill radera det här issuet?");
    ...
    return (
        ...
        <summary>Radera Issue</summary>
            <button className="issueButtons" onClick={deleteProject} >Radera Issue</button>
